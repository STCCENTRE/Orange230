...
//class for orangehrm loginpage
		System.out.println("Hello...Web page launching with Firefox...");
		System.setProperty("webdriver.gecko.driver","C:\\Users\\Abhilash\\Downloads\\geckodriver-v0.26.0-win64\\geckodriver.exe");
		WebDriver driver = new FirefoxDriver();
		driver.manage().timeouts().implicitlyWait(40,TimeUnit.SECONDS);
		driver.get("http://localhost/orangehrm/orangehrm-5.4%20(1)/orangehrm-5.4/web/index.php/auth/login");
		driver.findElement(By.name("username")).sendKeys("Admin");
		driver.findElement(By.name("password")).sendKeys("Passwd811#");
